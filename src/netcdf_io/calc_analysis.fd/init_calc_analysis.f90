...
contains
  subroutine read_nml
    ...
    !! as executable
    use vars_calc_analysis, only: anal_file, fcst_file, incr_file, aero_file, use_nemsio_anl, &
                                  do_aero, fhr, mype, npes, jedi, cliptracers
    implicit none
    ...
    namelist /setup/ datapath, analysis_filename, firstguess_filename, increment_filename, &
                     aero_inc_filename, fhr, use_nemsio_anl, do_aero, jedi, cliptracers
